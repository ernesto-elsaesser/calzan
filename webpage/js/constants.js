...
const boardTemplate = {
    ...
    "O2": {"v": -6, "h": -2, "tile": true},
    "O3": {"v": -6, "h": 2, "tile": true, "rate": 2, "trade": 4},
    "O4": {"v": -6, "h": 6, "tile": true},
    "O5": {"v": -4, "h": 8, "tile": true, "rate": 3},
    "O6": {"v": -2, "h": 10, "tile": true},
    "O7": {"v": 0, "h": 12, "tile": true, "rate": 3},
    "O8": {"v": 2, "h": 10, "tile": true},
    "O9": {"v": 4, "h": 8, "tile": true, "rate": 2, "trade": 2},
    "O10": {"v": 6, "h": 6, "tile": true},
    "O11": {"v": 6, "h": 2, "tile": true, "rate": 2, "trade": 1},
    "O12": {"v": 6, "h": -2, "tile": true},
    "O13": {"v": 6, "h": -6, "tile": true, "rate": 3},
    "O14": {"v": 4, "h": -8, "tile": true},
    "O15": {"v": 2, "h": -10, "tile": true, "rate": 2, "trade": 3},
    "O16": {"v": 0, "h": -12, "tile": true},
    "O17": {"v": -2, "h": -10, "tile": true, "rate": 2, "trade": 5},
    "O18": {"v": -4, "h": -8, "tile": true},
    ...
    "A1": {"v": -4, "h": -4, "tile": true, "nodes": ["A1A", "A1B", "A2A", "B2B", "B2A", "B1B"]},
    "A2a": {"v": -4, "h": -2, "edge": true, "dir": 0, "nodes": ["B2B", "A2A"]},
    "A2": {"v": -4, "h": 0, "tile": true, "nodes": ["A2A", "A2B", "A3A", "B3B", "B3A", "B2B"]},
    "A3a": {"v": -4, "h": 2, "edge": true, "dir": 0, "nodes": ["B3B", "A3A"]},
    "A3": {"v": -4, "h": 4, "tile": true, "nodes": ["A3A", "A3B", "A3C", "B4B", "B4A", "B3B"]},
    ...
    "B1": {"v": -2, "h": -6, "tile": true, "nodes": ["B1A", "B1B", "B2A", "C2B", "C2A", "C1B"]},
    "B2a": {"v": -2, "h": -4, "edge": true, "dir": 0, "nodes": ["C2B", "B2A"]},
    "B2": {"v": -2, "h": -2, "tile": true, "nodes": ["B2A", "B2B", "B3A", "C3B", "C3A", "C2B"]},
    "B3a": {"v": -2, "h": 0, "edge": true, "dir": 0, "nodes": ["C3B", "B3A"]},
    "B3": {"v": -2, "h": 2, "tile": true, "nodes": ["B3A", "B3B", "B4A", "C4B", "C4A", "C3B"]},
    "B4a": {"v": -2, "h": 4, "edge": true, "dir": 0, "nodes": ["C4B", "B4A"]},
    "B4": {"v": -2, "h": 6, "tile": true, "nodes": ["B4A", "B4B", "B4C", "C5B", "C5A", "C4B"]},
    ...
    "C1": {"v": 0, "h": -8, "tile": true, "nodes": ["C1A", "C1B", "C2A", "D1B", "D1A", "C1D"]},
    "C2a": {"v": 0, "h": -6, "edge": true, "dir": 0, "nodes": ["D1B", "C2A"]},
    "C2": {"v": 0, "h": -4, "tile": true, "nodes": ["C2A", "C2B", "C3A", "D2B", "D2A", "D1B"]},
    "C3a": {"v": 0, "h": -2, "edge": true, "dir": 0, "nodes": ["D2B", "C3A"]},
    "C3": {"v": 0, "h": 0, "tile": true, "nodes": ["C3A", "C3B", "C4A", "D3B", "D3A", "D2B"]},
    "C4a": {"v": 0, "h": 2, "edge": true, "dir": 0, "nodes": ["D3B", "C4A"]},
    "C4": {"v": 0, "h": 4, "tile": true, "nodes": ["C4A", "C4B", "C5A", "D4B", "D4A", "D3B"]},
    "C5a": {"v": 0, "h": 6, "edge": true, "dir": 0, "nodes": ["D4B", "C5A"]},
    "C5": {"v": 0, "h": 8, "tile": true, "nodes": ["C5A", "C5B", "C5C", "C5F", "D4C", "D4B"]},
    ...
    "D1": {"v": 2, "h": -6, "tile": true, "nodes": ["D1A", "D1B", "D2A", "E1B", "E1A", "D1D"]},
    "D2a": {"v": 2, "h": -4, "edge": true, "dir": 0, "nodes": ["E1B", "D2A"]},
    "D2": {"v": 2, "h": -2, "tile": true, "nodes": ["D2A", "D2B", "D3A", "E2B", "E2A", "E1B"]},
    "D3a": {"v": 2, "h": 0, "edge": true, "dir": 0, "nodes": ["E2B", "D3A"]},
    "D3": {"v": 2, "h": 2, "tile": true, "nodes": ["D3A", "D3B", "D4A", "E3B", "E3A", "E2B"]},
    "D4a": {"v": 2, "h": 4, "edge": true, "dir": 0, "nodes": ["E3B", "D4A"]},
    "D4": {"v": 2, "h": 6, "tile": true, "nodes": ["D4A", "D4B", "D4C", "D4F", "E3C", "E3B"]},
    ...
    "E1": {"v": 4, "h": -4, "tile": true, "nodes": ["E1A", "E1B", "E2A", "E2D", "E1E", "E1D"]},
    "E2a": {"v": 4, "h": -2, "edge": true, "dir": 0, "nodes": ["E2D", "E2A"]},
    "E2": {"v": 4, "h": 0, "tile": true, "nodes": ["E2A", "E2B", "E3A", "E3D", "E2E", "E2D"]},
    "E3a": {"v": 4, "h": 2, "edge": true, "dir": 0, "nodes": ["E3D", "E3A"]},
    "E3": {"v": 4, "h": 4, "tile": true, "nodes": ["E3A", "E3B", "E3C", "E3F", "E3E", "E3D"]},
